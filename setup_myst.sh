...
docker exec myst1 myst config set payments.zero-stake-unsettled-amount 0.2 || true
sleep 2

echo "[INFO] Cấu hình myst2 ..."
docker exec myst2 myst config set payments.zero-stake-unsettled-amount 0.2 || true
sleep 2
