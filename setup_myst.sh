...
docker exec myst1 sh -c "myst config set payments.zero-stake-unsettled-amount 0.1"

echo "[INFO] Cấu hình myst2 ..."
docker exec myst2 sh -c "myst config set payments.zero-stake-unsettled-amount 0.1"
