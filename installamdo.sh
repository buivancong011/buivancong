...
# ==========================================
# 3. CHUẨN BỊ HỆ THỐNG (AWS STYLE - SILENT)
# ==========================================
...
# Tạo Swap 2GB (dd im lặng)
if [ ! -f /swapfile ]; then
    log "Khởi tạo Swap 2GB..."
...
# ==========================================
# 4. BẮT IP THÔNG MINH (AWS STYLE DETECTION)
# ==========================================
log "Dò tìm Interface và IP..."
...
# ==========================================
# 6. KHỞI CHẠY NODES (AWS NAMING STYLE)
# ==========================================
...
run_node_group() {
  ...
  # Đặt tên Node theo số (tm1, myst1...) giống bản AWS
  ...
  # Proxyrack UUID Logic (V1/V2 Support)
  if [[ "$ARCH" != "aarch64" ]]; then
    local PR_UUID=""
